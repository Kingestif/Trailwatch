export default function Navbar() {
  return (
    <div className="Navbar text-white flex justify-between text-2xl py-3 fixed w-full left-0 px-50 max-sm:text-sm max-sm:px-2 max-sm:static max-sm:bg-transparent items-center backdrop-blur-md bg-black/30">
